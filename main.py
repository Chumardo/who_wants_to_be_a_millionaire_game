...
question = Label(game_frame_mid, text="What name is traditionally given to the party held for a woman who is expecting a baby?", bg='black', fg='white', font=('arial', 14, 'bold'), justify=CENTER)
...
a_answer = Button(game_frame_bot, text="A answer", bg='blue', fg='white', width=30, height=2, font=('arial', 14, 'bold'))
...
b_answer = Button(game_frame_bot, text="B answer", bg='blue', fg='white', width=30, height=2, font=('arial', 14, 'bold'))
...
c_answer = Button(game_frame_bot, text="C answer", bg='blue', fg='white', width=30, height=2, font=('arial', 14, 'bold'))
...
d_answer = Button(game_frame_bot, text="D answer", bg='blue', fg='white', width=30, height=2, font=('arial', 14, 'bold'))
